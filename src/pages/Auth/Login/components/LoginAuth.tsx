...
const LoginAuth = () => {
  return (
    <button className="flex items-center justify-center gap-3 border rounded py-2 w-full hover:bg-gray-100 transition duration-300 ease-in-out">
      <GoogleIcon />
      <span className="text-sm font-[450]"> Continue with google </span>
    </button>
  );
};
